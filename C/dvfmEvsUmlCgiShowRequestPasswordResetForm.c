...
$Log: dvfmEvsUmlCgiShowRequestPasswordResetForm.c,v $
...
main (int argc, char **argv)
{
	...
	printf("            <div>\n");
	printf("                  <h2>\n");
	printf("                  %s\n", DvfmEvsUmlGetWebUserInterfaceMessage (dvfmEvsUmlResetPassword, dvfmEvsUmlLanguageSystem));
	printf("                  </h2>\n");
...
/* $RCSfile: dvfmEvsUmlCgiShowRequestPasswordResetForm.c,v $ */
