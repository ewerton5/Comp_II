...
#define DVFM_EVS_UML_MAXIMUM_LENGTH_CONFIG_FILE             DVFM_EVS_UML_MAXIMUM_CHARACTERS_LINE_FILE_CONFIG +1
#define DVFM_EVS_UML_BUFFER_SIZE_LINE_CONFIG_FILE           DVFM_EVS_UML_MAXIMUM_LENGTH_CONFIG_FILE + 1
...
#define DVFM_EVS_UML_ENCRYPTED_PASSWORD_BUFFER_SIZE     DVFM_EVS_UML_SIZE_ENCRYPTED_PASSWORD + 1
