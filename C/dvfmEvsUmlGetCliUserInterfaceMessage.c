...
$Log: dvfmEvsUmlGetCliUserInterfaceMessage.c,v $
...
main(int argc,char *argv[ ]) 
{
	...
	printf("%s\n", DvfmEvsUmlGetCliUserInterfaceMessage (dvfmEvsUmlUserInterfaceMessageNumber, dvfmEvsUmlLanguage));

	return DVFM_EVS_OK;
}
/* $RCSfile: dvfmEvsUmlGetCliUserInterfaceMessage.c,v $ */
