...
$Log: dvfmEvsUmlGetNcursesErrorMessage.c,v $
...
main(int argc,char *argv[ ]) 
{
	...
	printf("%s\n", DvfmEvsUmlGetNcursesErrorMessage (dvfmEvsUmlError, dvfmEvsUmlLanguage));

	return DVFM_EVS_OK;
}
/* $RCSfile: dvfmEvsUmlGetNcursesErrorMessage.c,v $ */
