 ...
 * $Log: dvfmEvsUmlApproveRegistrationRequest.h,v $
...
#define DVFM_EVS_UML_APPROVE_REGISTRATION_REQUEST_H "@(#)dvfmEvsUmlApproveRegistrationRequest.h $Revision: 1.1 $"
...
#endif
/* $RCSfile: dvfmEvsUmlApproveRegistrationRequest.h,v $ */
