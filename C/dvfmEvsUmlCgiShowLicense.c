...
$Log: dvfmEvsUmlCgiShowLicense.c,v $
...
main (int argc, char **argv)
{
	...
	printf("                  \n");
	printf("                  <p>\n");
	printf("                  		%s\n", DvfmEvsUmlGetWebUserInterfaceMessage (dvfmEvsUmlUseLicenseText, dvfmEvsUmlLanguageSystem));
	printf("                  </p>\n");
	printf("\n");
	printf("            </div>\n");
	printf("            <footer>\n");
...
/* $RCSfile: dvfmEvsUmlCgiShowLicense.c,v $ */
