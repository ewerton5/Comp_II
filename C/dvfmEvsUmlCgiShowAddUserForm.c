...
$Log: dvfmEvsUmlCgiShowAddUserForm.c,v $
...
main (int argc, char **argv)
{
	...
	printf("            <div>\n");
	printf("                  <h2>\n");
	printf("                        %s\n",  DvfmEvsUmlGetWebUserInterfaceMessage (dvfmEvsUmlAddPermanentUser, dvfmEvsUmlLanguageSystem));
	printf("                  </h2>\n");
	...
	printf("                              <tr>\n");
	printf("                                    <td>\n");
	printf("                                          %s:\n",  DvfmEvsUmlGetWebUserInterfaceMessage (dvfmEvsUmlConfirmationPassword, dvfmEvsUmlLanguageSystem));
	printf("                                    </td>\n");
	printf("                                    <td>\n");
	printf("                                          <input type=\"password\" name=\"dvfmEvsUmlPasswordConfirmation\" max=\"65\">\n");
	printf("                                    </td>\n");
	printf("                              </tr>\n");
	printf("                              <tr>\n");
	printf("                                    <td>\n");
	...
	printf("                                    </td>\n");
	printf("                                    <td>\n");
	printf("                                          <input type=\"submit\" value=\"%s\">\n",  DvfmEvsUmlGetWebUserInterfaceMessage (dvfmEvsUmlAdd, dvfmEvsUmlLanguageSystem));
	printf("                                    </td>\n");
	printf("                              </tr>\n");
	printf("                              <tr>\n");
	printf("                                    <td colspan=\"2\">\n");
	printf("                                          <input type=\"hidden\" name=\"dmlConfinFrationFileNameileName\" value=\"%s\">\n", dvfmEvsUmlConfigurationFileName);
	printf("                                    </td>\n");
	printf("                              </tr>\n");
	printf("                              <tr>\n");
	printf("                                    <td colspan=\"2\">\n");
	...
	printf("                  </form>\n");
	printf("                  <h2>\n");
	printf("                        %s\n",  DvfmEvsUmlGetWebUserInterfaceMessage (dvfmEvsUmlAddTemporaryUser, dvfmEvsUmlLanguageSystem));
	printf("                  </h2>\n");
	printf("                  <form action=\"?????\" method=\"post\">\n");
	printf("                        <table>\n");
	printf("                              <tr>\n");
	...
	printf("                                    </td>\n");
	printf("                                    <td>\n");
	printf("                                          <input type=\"submit\" value=\"adicionar\">\n");
	printf("                                    </td>\n");
	printf("                              </tr>\n");
	printf("                              <tr>\n");
	printf("                                    <td colspan=\"2\">\n");
...
/* $RCSfile: dvfmEvsUmlCgiShowAddUserForm.c,v $ */
