...
main (int argc, char **argv)
{
	...
	printf("            <div>\n");
	printf("                  <h2>\n");
	printf("                        Adicionar usuario permanente\n");
	printf("                  </h2>\n");
	...
	printf("                              <tr>\n");
	printf("                                    <td colspan=\"2\">\n");
	printf("                                          <input type=\"hidden\" name=\"dmlConfinFrationFileNameileName\" value=dvfmEvsUmlConfigurationFileName>\n");
	printf("                                    </td>\n");
	printf("                              </tr>\n");
	printf("                              <tr>\n");
	printf("                                    <td colspan=\"2\">\n");
	...
	printf("                  </form>\n");
	printf("                  <h2>\n");
	printf("                        Adicionar usuario temporario\n");
	printf("                  </h2>\n");
	printf("                  <form action=\"?????\" method=\"post\">\n");
	printf("                        <table>\n");
	printf("                              <tr>\n");
