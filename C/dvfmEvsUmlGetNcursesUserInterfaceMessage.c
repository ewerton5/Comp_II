...
$Log: dvfmEvsUmlGetNcursesUserInterfaceMessage.c,v $
Revision 1.3  2020/01/24 05:37:49  ewerton.silles
*** empty log message ***
...
main(int argc,char *argv[ ]) 
{
	...
	printf("%s\n", DvfmEvsUmlGetNcursesUserInterfaceMessage (dvfmEvsUmlUserInterfaceMessageNumber, dvfmEvsUmlLanguage));

	return DVFM_EVS_OK;
}
/* $RCSfile: dvfmEvsUmlGetNcursesUserInterfaceMessage.c,v $ */
